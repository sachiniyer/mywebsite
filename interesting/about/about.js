...
var createScene = function() {
    ...
    const animtext = new BABYLON.Animation("textAnimation", "position.z", 30, BABYLON.Animation.ANIMATIONTYPE_FLOAT, BABYLON.Animation.ANIMATIONLOOPMODE_CYCLE);
    ...
    textKeys.push({
	frame: 750,
	value: linenumber*movementamount
    });
    animtext.setKeys(textKeys);
    finaltext.animations = [];
    finaltext.animations.push(animtext);
    var anim = scene.beginAnimation(finaltext, 0, 750, false);
